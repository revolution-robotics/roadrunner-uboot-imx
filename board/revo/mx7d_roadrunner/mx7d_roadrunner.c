...
#include "mx7d_roadrunner_eeprom.h"
#endif
...
#define MANAGE_SOM_PAD_CTRL (PAD_CTL_PUS_PU5KOHM | PAD_CTL_PUE | \
	PAD_CTL_DSE_3P3V_98OHM)
...
iomux_v3_cfg_t const manage_som_pads[] = {
	(MX7D_PAD_EPDC_DATA03__GPIO2_IO3 | MUX_PAD_CTRL(MANAGE_SOM_PAD_CTRL)),
};
...
int checkboard(void)
{
	puts("Board: REVO i.MX7D Industrial Edge Gateway\n");
